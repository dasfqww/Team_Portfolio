...
public class GameManager : MonoBehaviour
{
    ...
    public float occupyingGageRed { get; set; }// 레드팀 점령게이지
    public float occupyingGageBlue { get; set; }// 블루팀 점령게이지

    public int occupyingRatioRed { get; set; }//레드팀 점령 유지 %
    public int occupyingRatioBlue { get; set; }//블루팀 점령 유지 %
